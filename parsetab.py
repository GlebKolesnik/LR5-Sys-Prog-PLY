...
_lr_productions = [
  ...
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','expr_parser.py',10),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','expr_parser.py',11),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','expr_parser.py',12),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','expr_parser.py',13),
  ('expression -> expression POWER expression','expression',3,'p_expression_binop','expr_parser.py',14),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','expr_parser.py',18),
  ('expression -> NUMBER','expression',1,'p_expression_number','expr_parser.py',22),
]
